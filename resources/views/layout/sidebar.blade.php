    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview {{ (Request::segment(2) == 'good' ) ? 'active' : ''  }}">
        ...
        <ul class="treeview-menu">
            <li class="{{ Request::segment(2) == 'good' && Request::segment(3) != 'printDisplay' && Request::segment(3) != 'zeroStock' && Request::segment(3) != 'exp' ? 'active' : ''  }}"><a href="{{ url('/' . $role . '/good/all/all/all/20') }}"><i class="fa fa-circle-o"></i> Daftar Barang</a></li>
